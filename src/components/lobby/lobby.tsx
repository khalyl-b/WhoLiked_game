  ...
  return <main className="shell py-6 sm:py-10">
    <div className="mx-auto max-w-2xl">
      ...
      <section className="panel mt-7 p-5 sm:p-7">
        ...
        <div className="mt-6 grid grid-cols-3 gap-2 text-center"><div className="rounded-xl bg-white/5 p-3"><div className="text-lg font-black">{state.room.settings.roundCount}</div><div className="text-xs text-zinc-500">Rounds</div></div><div className="rounded-xl bg-white/5 p-3"><div className="text-lg font-black">Likes</div><div className="text-xs text-zinc-500">Source</div></div><div className="rounded-xl bg-white/5 p-3"><div className="text-lg font-black">{state.room.settings.guessDurationSeconds}s</div><div className="text-xs text-zinc-500">Timer</div></div></div>
